...
function Slider() {
  ...
  // Mouse move effect for Discord section
  useEffect(() => {
    const discordSection = discordSectionRef.current;
    ...
    const handleMouseMove = (e) => {
      ...
      discordSection.style.background = `
        ...
        linear-gradient(135deg, #ffb6c1 0%, #87ceeb 50%, #dda0dd 100%)
      `;
    };

    const handleMouseLeave = () => {
      discordSection.style.background = 'linear-gradient(135deg, #ffb6c1 0%, #87ceeb 50%, #dda0dd 100%)';
    };

    discordSection.addEventListener('mousemove', handleMouseMove);
    discordSection.addEventListener('mouseleave', handleMouseLeave);

    return () => {
      discordSection.removeEventListener('mousemove', handleMouseMove);
      discordSection.removeEventListener('mouseleave', handleMouseLeave);
    };
  }, []);
...
Build skills that open doors to your next big opportunity.
      ...
      <div 
        ...
        className="relative w-[92%] sm:w-[90%] md:w-[85%] mx-auto mt-16 rounded-2xl overflow-hidden shadow-2xl transition-all mb-12 duration-500"
        style={{
          background: 'linear-gradient(135deg, #ffb6c1 0%, #87ceeb 50%, #dda0dd 100%)'
        }}
      >
        {/* Glowy Border */}
        <div className="absolute inset-0 rounded-2xl border-4 border-transparent bg-gradient-to-r from-pink-300 via-blue-300 to-purple-300 opacity-80 blur-lg animate-pulse"></div>
        <div className="absolute inset-[3px] rounded-2xl bg-gradient-to-br from-pink-100/90 via-blue-100/90 to-purple-100/90 backdrop-blur-sm"></div>

        {/* Content */}
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-6 sm:p-8">
          {/* Left QR Code Section */}
          <div className="md:w-1/2 flex justify-center p-4 sm:p-6">
            <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300 border border-white/50">
              <img
                src="/discordqr.jpeg"
                alt="Discord Community QR Code"
                className="w-56 h-56 sm:w-64 sm:h-64 object-contain mx-auto"
              />
              <p className="text-center text-sm sm:text-base text-gray-700 mt-3 font-semibold">
          ...
          {/* Right Text Section */}
          <div className="md:w-1/2 px-4 sm:px-8 py-6 md:py-8">
            <h1 className="text-gray-800 text-2xl sm:text-3xl md:text-4xl font-bold leading-snug">
              Join our growing community
              <br />
              <span className="block text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-blue-500 to-purple-500 mt-2">
                ON DISCORD !!
              </span>
            </h1>

            <p className="text-gray-700 text-base sm:text-lg mt-4 max-w-md leading-relaxed font-medium">
              Connect with like-minded learners, get real-time updates on events, participate in exclusive discussions, 
              and be the first to know about new opportunities. Our Discord community is where the magic happens!
            </p>

            <div className="mt-6 flex flex-wrap gap-4">
              <div className="flex items-center text-gray-700 text-sm sm:text-base font-semibold">
              ...
              <div className="flex items-center text-gray-700 text-sm sm:text-base font-semibold">
                <div className="w-3 h-3 bg-purple-500 rounded-full mr-3 shadow-lg"></div>
